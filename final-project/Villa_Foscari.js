...
var central_sx = STRUCT([left_central,architrave_1st_window,base_1st_window,middle_central,architrave_2nd_window,base_2nd_window,right_central,architrave_door]);
...
!(function(exports){
//var main_building = T([0,2])([-29,11.22])(CUBOID([32.4,20.325,20.88]));
//613 è lunghezza
//384 è altezza
//5.593 altezza porta
//finestra = 614:32.4 = 37: x => 1.952
//11.22 - 1.952*3 / 3
//1.788
var g = 29;
...
//var MAIN = T([0])([2.75])(STRUCT([main_building,building,toppa_1,toppa_2]));
...
!(function(exports){
  ...
  var base_2_B = T([0,1,2])([-21.58,14.605,5.15])(CUBOID([1.52,0.75,6]));
   ...
   //domTRI36 = T([1,2])([-0.15,28.8])(domTRI33);
  k = 0.41666;
  c = 0.25;
  h = -3.75
  d = 0.15
  ...
  m = 29.85
  q  = (k + c);
  var base_triangolo = T([0,1])([-9.75,-3.5])(CUBOID([19.5,0.1,6.57]));//6.57
...
/*var anta_dx_window_14 = T([0,1,2])([-28.9,7.25,27.7])(antadx_lato);
var anta_sx_window_14 = T([0,1,2])([-28.75,7.25,29.7])(anta_piatta_lato);*/
...
/*
**
** Drawing bricks in villa's walls
**
*/

!(function(exports){

  var brick_left = CUBOID([0.03,0.5,0.0000000001]);
  var brick_right = T([0])([1.47])(CUBOID([0.03,0.5,0.0000000001]));
  var brick_up = T([1])([0.47])(CUBOID([1.5,0.03,0.0000000001]));
  var brick_down = CUBOID([1.5,0.03,0.0000000001])
  var base_brick = COLOR([209/255,209/255,209/255,1])(STRUCT([brick_down,brick_up,brick_right,brick_left]));

/*Front Bricks*/


var line_of_bricks = [];
var second_line_of_bricks = [];
i = 1.75;
q = 1.5;

var brick = T([0,1,2])([i,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*2,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*3,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*4,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*5,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*6,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*7,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*8,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*9,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*10,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*11,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*12,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*13,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*14,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*15,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*16,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*17,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*18,13.8,11.2])(base_brick);
second_line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*19,13.8,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*20,13.8,11.2])(base_brick);
line_of_bricks.push(brick);
...
var brick = T([0,1,2])([i,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*2,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*3,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*4,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*5,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*6,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*7,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*8,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*9,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*10,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*11,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*12,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*13,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*14,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*15,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*16,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*17,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*18,13.3,11.2])(base_brick);
line_of_bricks.push(brick);
var brick = T([0,1,2])([i-q*19,13.3,11.2])(base_brick);
line_of_bricks.push(brick);


var bricks = STRUCT(second_line_of_bricks);
var bricks_2 = STRUCT(line_of_bricks);

var bricks_3 = T([1])([-1])(bricks);
var bricks_4 = T([1])([-1])(bricks_2);
var bricks_5 = T([1])([-2])(bricks);
var bricks_6 = T([1])([-2])(bricks_2);


  exports.model = STRUCT([exports.model,bricks,bricks_2,bricks_3,bricks_4,bricks_5,bricks_6]);
  exports.model = model;
...
//96:lunghezza scale = 62: x ==> 62*11.2 / 96 = 7.23 
//96:11.2 = 72:x = 72*11.2/96 = 8.4 -> differenza (1.17)
//96:11.2 = 52:x => 6.07
//96:11.2 = 13:x => 1.52
//96:11.2 = 17:x => 1.98 (lunghezza porta)
//altezza architrave => 90:5.5 = 22 :x
//altezza base => 90:5.5 = 41 :x
//altezza colonne => 89:5.4 = 108:x => 6.55
//mainbuilding(x) = 96:11.2 = 260 : x => 30.33 
//mainbuilding(z) = 96:11.2 = 179 : x => 20.88 
//mainbuilding(y) = 56 : 5.4 = 253 : x => 26.325
//altezza 253
//23.24
...
TO-DO: 
- mattoni (?)
- sentiero che porta alla villa
- finestre su scale
- sfarfallii vari
- disegnare meglio portoni

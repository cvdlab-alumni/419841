...
var punti = [[0,0,0],[0,2,0],[2.5,3,0],[3.5,2,0],[4, 0,w],[2,0,0],[0,0,0]];
var puntoInutile = [[0,0,0]];
var b = BEZIER(S0)(punti);
var b1 = BEZIER(S0)(puntoInutile);
...
stabilLaterals = T([1])([13])(stabilLaterals);
